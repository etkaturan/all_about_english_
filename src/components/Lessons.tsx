        ...
        {TIERS.map((t) => (
          <div
            ...
            className={`relative flex flex-col rounded-3xl p-8 text-left backdrop-blur-sm ${
              t.popular ? "border-2 border-royal md:-translate-y-3" : "border border-[var(--border)]"
            }`}
          ...
          >
            ...
            <div className="font-serif text-4xl">{price(t.base)}</div>
            <div className="m-0 mt-2 font-sans text-[14px] text-muted">{t.sub}</div>
            <div className="mt-6">
              <ContactButton
